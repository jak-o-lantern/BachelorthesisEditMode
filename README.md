...
<center> 3. Repeat quality check with FastQC </center>
You know how to do this

<center> 4. Abundance Estimation with Kraken2 and Bracken </center>
...
<center> 5. <i>De novo</i> Assembly using Megahit </center>
...
<center> 6. Readmapping using Bowtie2 </center>
...
<center> 6.1 Building a Bowtie2 Index </center>
...
<center> 6.2 Running the mapping </center>
...
<center> 7.1 creating the "raw" (not sorted or indexed) .bam file. </center>
...
<center> 7.2 sorting and indexing the file (r_bam > .bam and .bam.bai) </center>
...
<center> 8.3.1 Cutting the contigs into smaller pieces. </center>
...
<center> 8.3.2 Generating the coverage table. </center>
...
<center> 8.3.4 Merging the cut up contigs with the original contigs <c/enter>

<code> merge_cutup_clustering.py PATH-TO-CONCOCT-OUTPUT/clustering_gt1000.csv > OUTPUT-PATH/clustering_merged.csv </code>

<center> 8.3.5 Extracting the bins as FASTA files </center>
...
<center> 9. Bin refinement using METAWRAP </center>
...
<center> 10. Classification of assembled reads </center>
...
<center> 11. Analysing statistics for the created bins using CheckM </center>
...
<center> 12. Bin targeted reassembly </center>
